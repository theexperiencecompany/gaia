...
COLLECTIONS_IMPORT_ALLOWLIST: frozenset[str] = frozenset(
    {
        ...
        "services/triggers/handlers/github.py",
        "services/triggers/handlers/gmail.py",
        "services/triggers/handlers/google_docs.py",
        "services/triggers/handlers/google_sheets.py",
        "services/triggers/handlers/linear.py",
