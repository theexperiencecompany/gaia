  ...
  return (
    <div>
      <Link href={`/blog/${blog.slug}`} className="block">
        <div className="grid grid-cols-[minmax(0,4fr)_minmax(0,1.5fr)_minmax(0,1fr)_minmax(0,0.7fr)] items-center rounded-lg px-3 py-3 transition-all hover:bg-surface-200">
