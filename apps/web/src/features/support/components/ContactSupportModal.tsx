            ...
            <ModalBody>
              <div className="flex flex-col gap-4">
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    variant="flat"
                    color={dragActive ? "primary" : "default"}
                    radius="lg"
                    className={`h-auto w-full cursor-pointer text-center transition-all duration-200 ${dragActive ? "scale-[1.02]" : ""}`}
                  ...
                  >
                    <div className="flex flex-col items-center space-y-2">
                      <div
                        className={`rounded-full p-4 ${dragActive ? "bg-primary/10" : "bg-zinc-700"} transition-colors`}
                      >
                        <Upload01Icon
                          className={`h-8 w-8 ${dragActive ? "text-blue-400" : "text-zinc-400"} transition-colors`}
                        />
                      </div>

                      <div className="space-y-1">
                        <p
                          className={`font-medium ${dragActive ? "text-blue-400" : "text-zinc-200"} transition-colors`}
                        >
                          {dragActive
                      ...
                      <div className="flex flex-wrap items-center justify-center gap-2 text-xs text-zinc-400">
                        ...
                        <span className="rounded-full bg-zinc-700 px-3 py-1">
                          Up to {FORM_VALIDATION.MAX_FILE_SIZE / (1024 * 1024)}
                          MB each
                        </span>
                        <span className="rounded-full bg-zinc-700 px-3 py-1">
                          JPG, PNG, WebP
