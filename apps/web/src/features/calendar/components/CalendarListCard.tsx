          ...
          {Object.entries(eventsByDay).map(([dateString, dayEvents]) => (
            <div key={dateString} className="space-y-3">
              <div className="relative flex items-center">
                <div className="flex-1 border-t border-border-surface-700" />
              ...
              <div className="space-y-2">
                {dayEvents.map((event) => {
                  ...
                  return (
                    <div
                      key={`${event}`}
                      className="relative flex items-start gap-2 rounded-lg p-3 pl-5 transition-colors hover:bg-surface-700/50"
                      style={{
