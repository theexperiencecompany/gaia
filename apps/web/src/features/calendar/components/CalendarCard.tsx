...
const CalendarCard: React.FC<CalendarCardProps> = ({
  ...
  return (
    <button
      type="button"
      className="hover:bg-opacity-100 relative z-1 w-full cursor-pointer overflow-hidden rounded-lg p-4 text-white shadow-md transition-colors duration-200 text-left"
      onClick={onClick}
    >
      <div
