  ...
  return (
    ...
    >
      <div className="flex shrink-0 items-center gap-1.5 border-b border-zinc-800 px-5 py-3">
        ...
        <span className="text-sm font-semibold text-zinc-200">engineering</span>
      </div>
          ...
          >
            ...
            <div>
              <div className="mb-1 flex items-baseline gap-2">
                ...
                <span className="text-[11px] text-zinc-600">9:22 AM</span>
              </div>
              <p className="text-sm text-zinc-300">
                <span className="font-semibold text-primary">@GAIA</span>{" "}
                what&apos;s the status on the payments integration?
              </p>
            </div>
          </m.div>
        )}
        ...
        {phase >= 3 && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-zinc-300">
                Payments integration (ENG-380) is 80% done. feat/payments-stripe
                merged last Thursday. Remaining: webhook handling (ENG-391, in
                review by Alex — 3 days) and error states (ENG-394, not
                started). Estimated ship: Monday if ENG-391 merges today.
              </p>
            </div>
          </m.div>
        )}
