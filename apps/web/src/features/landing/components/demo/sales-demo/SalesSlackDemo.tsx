  ...
  return (
    ...
    >
      <div className="flex shrink-0 items-center gap-1.5 border-b border-zinc-800 px-5 py-3">
        ...
        <span className="text-sm font-semibold text-zinc-200">sales-team</span>
      </div>
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <div className="mb-1.5 flex items-baseline gap-2">
                ...
                <span className="text-[11px] text-zinc-600">8:00 AM</span>
              </div>
              <p className="text-sm text-zinc-300">
                Good morning. Today&apos;s priority: Acme Corp trial expires
                Friday. Follow-up email drafted and ready to send.
              </p>
            </div>
          </m.div>
        )}
          ...
          >
            ...
            <div>
              <div className="mb-1 flex items-baseline gap-2">
                ...
                <span className="text-[11px] text-zinc-600">9:14 AM</span>
              </div>
              <p className="text-sm text-zinc-300">
                <span className="font-semibold text-primary">@GAIA</span> where
                does the TechFlow deal stand?
              </p>
            </div>
          </m.div>
        )}
        ...
        {phase >= 3 && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-zinc-300">
                TechFlow ($67K) is in Proposal Sent stage, day 8. Last contact
                March 2nd (you sent pricing). Their CFO approved budget last
                week per LinkedIn. Suggested next step: schedule a sign-off call
                with the CFO this week. Want me to draft the ask?
              </p>
            </div>
          </m.div>
        )}
