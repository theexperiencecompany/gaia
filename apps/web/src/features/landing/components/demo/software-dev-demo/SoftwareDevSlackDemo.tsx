          ...
          >
            ...
            <div>
              <div className="mb-1 flex items-baseline gap-2">
                ...
                <span className="text-[11px] text-zinc-600">9:04 AM</span>
              </div>
              <p className="text-sm text-zinc-300">
                <span className="font-semibold text-primary">@GAIA</span>{" "}
                what&apos;s the current status of the payments integration?
              </p>
            </div>
          </m.div>
        )}
        {phase >= 3 && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-zinc-300">
                The payments integration (ENG-380) is 80% done.
                feat/payments-stripe was merged last Thursday. Remaining:
                webhook handling (ENG-391, in review by Alex) and error states
                (ENG-394, not started). Estimated ship: next Monday.
              </p>
            </div>
          </m.div>
        )}
