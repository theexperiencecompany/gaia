        ...
        {phase >= 3 && (
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-zinc-300">
                2 blockers on feat/auth-refactor: Alex&apos;s PR needs your
                review (23 files changed), and Maya is waiting on the API schema
                decision from Monday&apos;s thread. Both are merge-blocking.
              </p>
            </div>
          </m.div>
        )}
