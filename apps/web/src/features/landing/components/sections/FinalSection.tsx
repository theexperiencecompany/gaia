  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="z-1 mb-3 max-w-sm px-4 py-0 text-center text-base leading-6 font-light text-white sm:mb-6 sm:max-w-(--breakpoint-md) sm:px-0 sm:text-xl sm:leading-7 md:text-2xl max-[760px]:mb-2 max-[760px]:text-[1.05rem] max-[760px]:leading-6">
