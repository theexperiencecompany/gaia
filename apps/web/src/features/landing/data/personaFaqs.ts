export const FOUNDERS_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes. GAIA connects to your Google Sheets, Notion, and email to pull the latest metrics (MRR, churn, pipeline), drafts the investor update in your voice, and sends it on schedule. You spend 5 minutes reviewing instead of 2 hours writing.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. GAIA is fully open source, available on GitHub under The Experience Company. You can self-host it or use the cloud version at heygaia.io.",
  },
  {
    question: "How long does it take to set up GAIA for a startup?",
    answer:
      "Most founders are fully set up within 30 minutes. Connect your tools, configure your daily briefing preferences, and GAIA starts working immediately. There's no complex workflow builder required.",
  },
];

export const SOFTWARE_DEV_FAQS = [
  {
    question: "Can GAIA automatically write my daily standup?",
    answer:
      "Yes. GAIA monitors your GitHub commits, Linear tickets, and Slack activity, then generates a concise standup report (what you did, what you're doing, blockers) every morning. You review and post in 30 seconds.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "GAIA integrates with GitHub, Linear, Slack, Jira, Notion, Sentry, and Datadog. It creates a unified view of your dev workflow across all these tools and surfaces what actually needs your attention.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. GAIA integrates with Sentry and Datadog to monitor error rates and incidents, and sends alerts to Slack or email with context about what changed and potential causes.",
  },
  {
  ...
  {
    question:
      "Can GAIA integrate with Linear for developer workflow automation?",
    answer:
      "Yes. GAIA integrates deeply with Linear to monitor ticket status, track sprint progress, surface blocked issues, and include Linear context in your daily standup and briefings.",
  },
];

export const SALES_FAQS = [
  {
    question: "How does GAIA help sales professionals manage their pipeline?",
    answer:
      "GAIA monitors your HubSpot or Salesforce pipeline continuously, identifies deals at risk of going cold, and drafts follow-up emails before you even remember to check. You stay on top of every deal without living in your CRM.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. GAIA integrates natively with HubSpot, Salesforce, and other popular CRMs. It monitors deal stages, contact activity, and pipeline health continuously without you needing to check.",
  },
  {
    question: "Can GAIA draft follow-up emails for my deals?",
    answer:
      "Yes. When GAIA detects a deal hasn't had activity in a set period, it drafts a personalized follow-up email based on the deal context and your previous correspondence. You approve and send in one click.",
  },
  {
    question: "How much time can I save using GAIA as a sales rep?",
    answer:
      "Sales reps typically save 5-10 hours per week on CRM updates, follow-up drafting, and meeting prep. GAIA handles the admin so you can spend more time in actual sales conversations.",
  },
  {
...
export const PM_FAQS = [
  {
    question: "How does GAIA help product managers with stakeholder updates?",
    answer:
      "GAIA pulls data from Linear, GitHub, and Notion to generate weekly stakeholder update drafts automatically. You spend 10 minutes reviewing instead of an hour writing.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. GAIA deeply integrates with Linear to track sprint progress, surface blocked tickets, generate sprint reports, and help you run your planning process with less overhead.",
  },
  {
    question: "Can GAIA generate sprint reports automatically?",
    answer:
      "Yes. At the end of each sprint, GAIA pulls completed tickets, velocity data, and blocker history from Linear and GitHub, then generates a comprehensive sprint report ready to share with stakeholders.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. You can ask GAIA to draft product briefs from context in your Notion, Slack threads, and Linear tickets. It synthesizes scattered context into structured documents.",
  },
  {
...
export const EM_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes. GAIA generates weekly and sprint-level reports from GitHub and Linear data automatically. Share them with stakeholders without spending hours in Confluence.",
  },
  {
...
export const AGENCY_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes. GAIA pulls project data from your project management tool, structures it into a professional status report, and sends it to clients on schedule. You review and approve, or let it run fully automated.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "GAIA tracks task completion rates, overdue milestones, budget burn, and team activity across all client projects. It surfaces at-risk projects proactively so you can course-correct before a client notices.",
  },
  {
    question: "Can GAIA handle client communication on my behalf?",
    answer:
      "GAIA can draft client emails, status updates, and meeting summaries based on project data and context. You review and send, keeping communication consistent and timely without writing every message from scratch.",
  },
];
