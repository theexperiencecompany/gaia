...
export const entry: AlternativeData = {
  ...
  painPoints: [
    "Linear's cycles, projects, and triage workflows are designed for engineering sprints, so solo users and non-eng teams get complexity they don't need",
  ...
  gaiaAdvantages: [
    "GAIA handles personal tasks, email, and calendar together, while Linear handles only engineering issues",
  ...
  faqs: [
    {
      ...
      answer:
        "GAIA is a personal AI productivity assistant that handles tasks, email, calendar, and automations for individuals and small teams. It lacks Linear's engineering-specific features like cycles, sprints, and GitHub issue sync, but covers personal productivity breadth that Linear doesn't touch.",
    },
    {
