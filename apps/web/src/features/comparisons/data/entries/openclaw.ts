...
export const entry: ComparisonData = {
  ...
  rows: [
    ...
    },
    {
      ...
      competitor: "CLI and messaging channels only, with no GUI app",
    },
    {
    ...
    },
    {
      ...
      competitor:
        "Persistent local SQLite memory (Task Brain) that stores tasks, context, and patterns locally on your machine",
    },
    {
    ...
    },
    {
      ...
      gaia: "AI-powered todo management that creates tasks from emails, assigns priorities, and tracks completion automatically",
      competitor:
    ...
    },
    {
      ...
      competitor:
        "No unified view: all interaction happens via messaging threads",
    },
    {
      feature: "Open source",
