...
export const entry: ComparisonData = {
  ...
  rows: [
    ...
    },
    {
      ...
      competitor:
        "AppleScript, Shortcuts, URL scheme, and OmniFocus Automation (JavaScript) for scripted workflows, powerful but requiring technical setup",
    },
    {
  ...
  competitorAdvantages: [
    ...
    "One-time purchase with no recurring subscription, lowering long-term cost for Apple-only users",
