...
export const entry: ComparisonData = {
  ...
  metaDescription:
    "Compare GAIA and Pipedream. Pipedream gives developers code-level automation power, but GAIA manages email, calendar, tasks, and workflows through natural language, with no code required.",
  keywords: [
    "GAIA vs Pipedream",
