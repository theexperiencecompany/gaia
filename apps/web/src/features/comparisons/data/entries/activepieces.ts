...
export const entry: ComparisonData = {
  ...
  rows: [
    ...
    },
    {
      ...
      gaia: "50+ deep integrations via MCP including Gmail, Google Calendar, Slack, Notion, GitHub, Linear, and more, with bi-directional API actions available to the AI agent at runtime",
      competitor:
  ...
  competitorAdvantages: [
    ...
    "Unlimited task runs on all paid plans and the self-hosted Community Edition means costs stay fully predictable as automation volume scales, with no per-execution pricing",
  ],
  verdict:
