...
export const entry: ComparisonData = {
  ...
  description:
    "Limitless AI is a memory-capture platform built around a wearable pendant and desktop app that transcribes and summarizes conversations and meetings. GAIA is a proactive productivity OS that manages your email, calendar, tasks, and workflows across 50+ integrations, with no hardware required.",
  metaTitle:
  ...
  rows: [
    ...
    },
    {
      ...
      competitor:
        "Pendant hardware ($99 to $299) required for capturing in-person conversations; desktop app handles virtual meetings via screen and microphone recording",
    },
    {
