...
export const entry: ComparisonData = {
  ...
  rows: [
    ...
    },
    {
      ...
      gaia: "50+ integrations via MCP: Gmail, Google Calendar, Slack, GitHub, Linear, Notion, Todoist, Asana, Jira, and more, also supporting MCP connections to code-adjacent tools",
      competitor:
    ...
    },
    {
      ...
      gaia: "Graph-based persistent memory connects code work with tasks, meetings, emails, and communications, so context accumulates over time across every tool",
      competitor:
  ...
  gaiaAdvantages: [
    ...
    "Natural language workflow automations span email, calendar, tasks, and messaging, with no manual stitching between tools required",
