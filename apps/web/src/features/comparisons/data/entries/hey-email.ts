...
export const entry: ComparisonData = {
  ...
  rows: [
    ...
    },
    {
      ...
      gaia: "Automatically extracts action items from emails and converts them into structured tasks with priorities, deadlines, and project assignments, with no manual intervention required",
      competitor:
