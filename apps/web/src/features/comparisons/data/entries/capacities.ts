...
export const entry: ComparisonData = {
  ...
  metaTitle: "GAIA vs Capacities: AI Productivity OS vs Object-Based PKM",
  metaDescription:
  ...
  keywords: [
    ...
    "AI PKM tool",
    "Capacities.io vs AI assistant",
    "object-based PKM alternative",
    "personal knowledge management AI",
    "Capacities vs proactive AI",
    "open source Capacities alternative",
    "AI second brain tool 2026",
    "PKM vs AI productivity OS",
    "Capacities replacement",
  ...
  rows: [
    ...
    },
    {
      ...
      competitor:
        "No native calendar integration; meeting notes can be created as objects but calendar events are not synced or managed",
    },
    {
      ...
      competitor:
        "Task objects can be created and linked to projects, people, and notes; no AI-driven task creation from external sources or calendar context",
    },
    {
    ...
    },
    {
      ...
      competitor:
        "Free plan with unlimited notes, 5 GB storage, offline access, and core features; paid tiers from $10/month for additional storage and premium features",
    },
  ],
  gaiaAdvantages: [
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Yes, for deliberate note-taking and structured knowledge management, Capacities is the more capable dedicated tool. GAIA captures context from emails, meetings, and tasks automatically, but it is not a note-taking application with a rich writing interface, custom object types, and a knowledge graph you curate intentionally. If rich note composition and a personal knowledge base you build over time are primary needs, Capacities is the right tool. If you want an AI that handles your daily operational work proactively, GAIA is the better fit.",
    },
  ],
};
