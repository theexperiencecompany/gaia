...
export const entry: ComparisonData = {
  ...
  metaDescription:
    "Harvest tracks time and invoices clients, but it won't manage your tasks or automate your workflow. GAIA is an open-source AI alternative with email integration, task management, and 50+ tool connections, with a free tier available.",
  keywords: [
    "Harvest alternative",
    "GAIA vs Harvest",
