...
export const entry: ComparisonData = {
  ...
  metaTitle: "GAIA vs Make: AI Assistant vs Visual Automation Platform",
  metaDescription:
  ...
  rows: [
    {
      ...
      competitor:
        "Visual no-code automation platform — build scenarios by connecting modules on a canvas with explicit data mapping, routing, and error handling",
    },
    {
      feature: "Setup complexity",
      gaia: "Natural language setup — describe what you want in plain English; no scenario-building, data mapping, or module configuration required",
      competitor:
        "Requires explicit scenario design: choose trigger, connect modules, map data fields, configure routers and filters, and test before deploying",
    },
    {
      feature: "AI & intelligence",
      gaia: "Full AI reasoning layer — reads email content, understands context, makes judgment calls, and adapts based on graph-based memory of your work history",
      competitor:
        "AI actions available as modules (OpenAI, Claude, Gemini); logic must be pre-defined; no system-level AI that understands your full context autonomously",
    },
    {
      ...
      competitor:
        "Gmail module for reading, sending, searching, and labeling email; can build triage flows but requires manual scenario design for each use case",
    },
    {
      ...
      competitor:
        "Google Calendar module for creating and reading events; scheduling logic must be hand-built in scenarios with explicit conditions",
    },
    {
      ...
      competitor:
        "Todoist, Asana, Linear, and other task tool modules for creating and updating tasks; no native task management; task creation requires a configured scenario",
    },
    {
    ...
    },
    {
      ...
      competitor:
        "Scenarios run on defined schedules or triggers; no proactive intelligence layer that monitors context and acts based on changing circumstances",
    },
    {
      ...
      competitor:
        "Closed-source SaaS; no self-hosting option; data subject to Make's privacy policy",
    },
    {
      feature: "Pricing",
      gaia: "Free tier available; Pro from $20/month; self-hosting entirely free with no usage caps",
      competitor:
        "Free plan with 1,000 operations/month; Core plan from $29/month; Pro and Teams plans for higher volume; operations-based billing that scales with usage",
    },
  ],
  gaiaAdvantages: [
