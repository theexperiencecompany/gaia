...
export const entry: ComparisonData = {
  ...
  rows: [
    ...
    {
      feature: "Open source",
      gaia: "Fully open source and self-hostable via Docker, so you own your data entirely and deploy on your own infrastructure",
  ...
  gaiaAdvantages: [
    ...
    "Open source and self-hostable, with full data ownership and no per-user pricing when deployed on your own infrastructure",
  ],
  competitorAdvantages: [
    "Recipient calendar overlay is a genuine UX improvement over standard booking links, letting guests see mutual availability without switching tabs",
