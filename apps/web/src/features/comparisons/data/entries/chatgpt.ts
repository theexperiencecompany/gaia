...
export const entry: ComparisonData = {
  ...
  rows: [
    ...
    },
    {
      ...
      competitor:
        "Limited proactive behavior via Tasks feature: supports up to 10 scheduled reminders that send push notifications on a fixed schedule",
    },
    {
    ...
    },
    {
      ...
      competitor:
        "Plus/Pro plans can read your Google Calendar and suggest free slots when asked; cannot create or edit events autonomously",
    },
    {
      ...
      competitor:
        "Tasks feature allows up to 10 scheduled reminders with push notifications; no project hierarchy, labels, or semantic search",
    },
    {
      feature: "Workflow automation",
      gaia: "Multi-step automations described in natural language with triggers, conditions, and cross-tool actions spanning email, calendar, Slack, Notion, and more",
      competitor:
        "No native workflow automation engine; can help write automation scripts or instructions, but does not execute multi-step cross-tool actions",
    },
    {
