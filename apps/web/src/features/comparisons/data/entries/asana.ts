...
export const entry: ComparisonData = {
  ...
  rows: [
    ...
    },
    {
      ...
      gaia: "Ambient AI that proactively manages work: summarizes threads, prepares meeting briefs, writes drafts, detects priorities, and orchestrates cross-tool actions",
      competitor:
        "AI teammates for drafting, summarizing, and filling in task fields; AI-assisted workflow suggestions within the Asana interface",
    },
    {
      ...
      competitor:
        "Rules-based workflow automation within Asana (e.g., auto-assign, move task on status change); cross-tool automation via Zapier or Make",
    },
    {
      feature: "Proactive behavior",
      gaia: "Monitors email, calendar, and connected tools continuously to surface insights and take action before you ask",
      competitor:
        "Sends notifications and reminders based on task rules; does not proactively act on external context",
    },
    {
      feature: "Memory and context",
      gaia: "Graph-based persistent memory that links tasks, projects, meetings, documents, and people for deep contextual understanding over time",
      competitor:
        "Project and task history stored per workspace; no cross-project or cross-tool semantic memory",
    },
    {
    ...
    },
    {
      ...
      competitor:
        "Personal plan free (up to 15 members); Starter at $10.99/user/month; Advanced at $24.99/user/month (billed annually)",
    },
  ],
  gaiaAdvantages: [
  ...
  competitorAdvantages: [
    ...
    "270+ native integrations and an established ecosystem of templates and reporting dashboards",
  ...
  faqs: [
    {
      ...
      answer:
        "GAIA covers personal and team task management with AI-powered todo lists, semantic search, labels, priorities, projects, and deadlines. It also integrates directly with Asana via MCP, so you can use GAIA as an intelligent front-end that reads from and writes to your existing Asana workspace while adding proactive email triage, workflow automation, and persistent memory on top.",
    },
    {
