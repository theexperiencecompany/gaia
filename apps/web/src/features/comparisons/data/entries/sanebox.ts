...
export const entry: ComparisonData = {
  ...
  rows: [
    ...
    },
    {
      ...
      gaia: "Triages incoming email by urgency, auto-labels threads by category, and surfaces high-priority messages, adapting continuously using graph-based memory of your behavior and relationships",
      competitor:
