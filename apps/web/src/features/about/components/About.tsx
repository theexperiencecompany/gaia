...
// Static page content — declared at module scope so it isn't rebuilt (and
// doesn't look newly-allocated to memoized children) on every render.
        ...
        <div className="relative max-w-(--breakpoint-lg) space-y-8">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center -space-x-2">
              {ABOUT_DATA.authors.map((author: Author) => (
                <AuthorTooltip
                  key={author.name}
                  author={author}
                  avatarSize="md"
