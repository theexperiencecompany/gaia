...
function TwitterCard({ tweet }: { tweet: TwitterTweetData }) {
  ...
  return (
    <div
      className="group relative flex w-full flex-col gap-2 rounded-xl border border-default-200 bg-content1/50 p-4 backdrop-blur-sm transition-colors hover:border-default-300 hover:bg-content1/70"
