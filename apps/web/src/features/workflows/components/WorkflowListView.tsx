...
const WorkflowRow = memo(
  ({
    ...
    return (
      <button
        type="button"
        className="flex w-full cursor-pointer items-center gap-3 rounded-2xl bg-zinc-800/50 p-3 text-left transition-colors hover:bg-zinc-700/50 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
        onClick={handleClick}
      >
