...
import { EventCard as EventCardBefore } from "@/features/chat/components/bubbles/bot/CalendarEventCard";
import { EventContent as EventContentBefore } from "@/features/chat/components/bubbles/bot/CalendarEventContent";
...
export default function CalendarEventSectionBefore({
  calendar_options,
}: {
            ...
            <div className="space-y-2">
              {events.map(({ event, index, isSameDay }) => {
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-1 flex items-center gap-2 text-xs text-zinc-400">
                          ...
                          {sameDayEvent.calendarTitle && (
                            <>
                              {/* biome-ignore lint: intentional before-gallery */}
                ...
                return (
                  ...
                  >
                    <EventContentBefore event={event as CalendarEvent} />
                  </EventCardBefore>
                );
              })}
            </div>
