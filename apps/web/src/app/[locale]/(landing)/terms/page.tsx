      ...
      <div className="flex w-full flex-col items-center justify-center">
        <div className="privacy-policy w-full max-w-(--breakpoint-xl) px-4 pb-6 pt-24 sm:px-6 lg:px-8">
          ...
          <p className="mb-4">
            ...
            TO BE BOUND BY ALL TERMS AND CONDITIONS OF THIS AGREEMENT. IF YOU DO
            NOT AGREE TO THESE TERMS, YOU MAY NOT ACCESS OR USE THE SERVICE.
          </p>
          <p className="mb-4">
            <strong>
              SECTION 18 CONTAINS A BINDING ARBITRATION AGREEMENT AND A CLASS
              ACTION WAIVER. THEY AFFECT HOW DISPUTES BETWEEN YOU AND COMPANY
              ARE RESOLVED. YOU MAY OPT OUT OF ARBITRATION WITHIN THIRTY (30)
              DAYS AS DESCRIBED IN SECTION 18.5.
            </strong>
          </p>
          ...
          <div className="mb-4">
            ...
            <ul className="ml-6 list-disc">
              ...
              <li>
                Using the Service to generate or distribute spam, bulk
                unsolicited messages, malware, or content designed to deceive or
                defraud;
              </li>
              <li>
          ...
          <div className="mb-4">
            ...
            <ul className="mb-4 ml-6 list-disc">
              <li>
                <strong>Merchant of record:</strong> Payments for Premium
                Features are processed by Dodo Payments, which acts as the
                merchant of record and is the seller of record for your
                purchase. Your purchase is also subject to Dodo Payments' terms,
                and Dodo Payments is responsible for collecting and remitting
                applicable taxes;
              </li>
              <li>
              ...
              <li>
                The subscription price and billing frequency are disclosed to
                you on the pricing page and at checkout before you complete your
                purchase;
              </li>
              <li>
                You may cancel at any time from your account settings, as
                described in Section 5.3. Cancelling stops future renewals;
              </li>
              <li>
                Fees are charged in advance for each billing period, and you
                authorize Company and its payment processor to charge your
                designated payment method for all applicable fees, taxes, and
                other charges;
              </li>
              <li>
            ...
            <div className="mb-4">
              <p className="mb-2">
                Except as required by applicable law or as expressly stated
                below, fees paid for Premium Features are non-refundable:
              </p>
              <ul className="mb-4 ml-6 list-disc">
                <li>
                ...
                <li>
                  ...
                  Agreement limits any refund, cancellation, or withdrawal right
                  you have under applicable consumer protection law. Where such
                  a right applies, it prevails over this Section;
                </li>
                <li>
                  <strong>Exceptional Circumstances:</strong> Refunds may be
                  granted at Company's discretion in cases of technical errors,
                  duplicate charges, or other exceptional circumstances;
                </li>
                <li>
            ...
            <div className="mb-4">
              ...
              <ul className="mb-4 ml-6 list-disc">
                <li>
                  <strong>Self-Service Cancellation:</strong> Cancel directly
                  from your account settings. If you signed up online, you can
                  cancel online, without contacting us;
                </li>
                <li>
                ...
                <li>
                  <strong>No Partial Refunds:</strong> Except where required by
                  law, cancellation does not entitle you to a refund for the
                  current billing period or any unused portion thereof;
                </li>
                <li>
          ...
          <p className="mb-4">
            ...
            messages, AI model requests, connected integrations, storage,
            background workflows, and other resources. Applicable limits depend
            on your plan and are described in the Service. Company may set,
            change, or enforce usage limits at any time, including to protect
            the stability and security of the Service or to prevent abuse.
            Company may throttle, suspend, or reduce access where usage
            materially exceeds normal individual use or is inconsistent with
            your plan.
          </p>
          ...
          <div className="mb-4">
            <p className="mb-4">
              ...
              thereof (collectively, the "Company Content"), are and shall
              remain the exclusive property of Company and its licensors and are
            ...
            <p className="mb-2">
              ...
              access and use the Service as follows:
            </p>
            <ul className="mb-4 ml-6 list-disc">
              <li>
                <strong>Hosted Service, paid plans:</strong> Commercial and
                business use is permitted, including use by and on behalf of
          ...
          <div className="mb-4">
            ...
            <p className="mb-4">
              ...
              summaries, and suggestions. AI outputs may be inaccurate,
              incomplete, outdated, or misleading, and may misinterpret your
              instructions or the contents of your connected accounts. You are
              responsible for reviewing and verifying AI outputs before relying
              on them. AI outputs do not constitute legal, medical, financial,
              tax, or other professional advice, and you should not rely on them
            ...
            <p className="mb-2">
              ...
              instructing the assistant, you authorize Company to take actions
              in that connected account on your behalf. Depending on the
              integrations you enable, this may include sending and modifying
              email, creating and deleting calendar events, posting messages,
              modifying records in connected tools, and running scheduled
              workflows that act when you are not present.
            </p>
            <ul className="mb-4 ml-6 list-disc">
              <li>
                You are responsible for actions taken by the assistant under
                your account, including actions you approve and actions
                resulting from instructions, workflows, or automations you
                configure;
              </li>
              <li>
              ...
              <li>
                You should not authorize the assistant to act on accounts
                containing information you cannot afford to have modified or
                deleted without independent backups.
              </li>
            </ul>
          </div>
          ...
          <p className="mb-4">
            The Service connects to third-party products and services that
            Company does not own or control. Your use of any connected service
            is governed by that provider's own terms and privacy policy, and you
            are responsible for complying with them. Company does not warrant
            the availability, accuracy, or continued operation of any
            third-party service, and is not liable for any loss arising from a
            third-party service's downtime, errors, rate limits, changes to its
            API, suspension of your account with that provider, or
            discontinuation. A third-party provider may change or withdraw
            access at any time, which may remove functionality from the Service
            without notice.
          </p>
          ...
          <p className="mb-4">
            Company may modify, suspend, or discontinue the Service, or any
            feature or integration within it, at any time. Where Company
            discontinues the Service in its entirety, or discontinues a paid
            feature in a way that materially reduces the value of your
            subscription, Company will provide at least thirty (30) days' notice
            by email or prominent notice in the Service and will refund the
            unused prepaid portion of your then-current billing period. Company
            is not otherwise liable to you or any third party for modifying,
          ...
          <p className="mb-4">
            ...
            Sections 7, 8, 9, 13, 14, 15, 16, 18, and 19 shall survive
          ...
          <div className="mb-4">
            ...
            <ul className="ml-6 list-disc">
              ...
              <li>
                ...
                OF ANY CONTENT, AI OUTPUT, OR ACTION TAKEN BY THE ASSISTANT.
              </li>
            </ul>
            <p className="mt-2">
              NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED BY YOU
              FROM COMPANY OR THROUGH THE SERVICE SHALL CREATE ANY WARRANTY NOT
              EXPRESSLY STATED IN THIS AGREEMENT. SOME JURISDICTIONS DO NOT
              ALLOW THE EXCLUSION OF CERTAIN WARRANTIES, SO SOME OF THESE
          ...
          <p className="mb-4">
            ...
            SHALL NOT EXCEED THE GREATER OF (A) THE AMOUNT YOU PAID TO COMPANY
            FOR THE SERVICE DURING THE TWELVE (12) MONTHS PRECEDING THE CLAIM
            AND (B) ONE HUNDRED UNITED STATES DOLLARS (USD $100). SOME
            JURISDICTIONS DO NOT ALLOW THE LIMITATION OR EXCLUSION OF LIABILITY
            FOR CERTAIN DAMAGES, SO SOME OF THESE LIMITATIONS MAY NOT APPLY TO
            YOU.
          </p>
          ...
          <div className="mb-4">
            ...
            <p className="mb-4">
              ...
              This choice of law does not deprive you of the protection of any
              mandatory consumer law of the country or state in which you
              reside.
            </p>
            ...
            <p className="mb-4">
              ...
              Service that is not resolved informally shall be resolved by
              binding individual arbitration administered by the American
              Arbitration Association ("AAA") under its Consumer Arbitration
              Rules, as modified by this Agreement. The arbitration shall be
              seated in Wilmington, Delaware, and may be conducted by telephone,
              video conference, or on written submissions unless the arbitrator
              orders otherwise. If you are a consumer, you may elect to have the
              arbitration conducted in the county of your residence. Judgment on
            ...
            <ul className="mb-4 ml-6 list-disc">
              ...
              <li>
                ...
                infringement or misuse of intellectual property or unauthorized
            ...
            <p className="mb-4">
              ...
              terminate your account or otherwise penalize you for opting out.
            </p>
            ...
            <p className="mb-4">
              ...
              representative proceeding. If this Section 18.6 is found
              unenforceable as to a particular claim, that claim shall be
              severed from arbitration and brought in the courts located in
              Delaware, while all other claims remain in arbitration.
            </p>
            ...
            <p className="mb-4">
              If twenty-five (25) or more claimants submit demands for
              arbitration raising substantially similar claims and represented
              by the same or coordinated counsel, the parties agree the demands
              shall be administered in sequential batches of no more than fifty
              (50) at a time, with each batch resolved before the next begins.
              All applicable limitation periods are tolled for claimants
              awaiting a later batch. This provision is intended to make
              resolution more efficient and does not limit any claimant's right
              to relief.
            </p>
          </div>
