...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "On the cloud tier, your data is processed with strict security controls, and content from your connected accounts is never used to improve our services. On the self-hosted tier, your email content never leaves your own infrastructure — GAIA processes everything locally using your own LLM API key.",
  },
];
