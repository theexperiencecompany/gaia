 ...
 */
function getComparisonPages(): MetadataRoute.Sitemap {
 ...
 */
async function getPersonaPages(): Promise<MetadataRoute.Sitemap> {
  try {
 ...
 */
function getGlossaryPages(): MetadataRoute.Sitemap {
...
export default async function sitemap(props: {
  ...
  switch (id) {
    ...
    case SITEMAP_IDS.PERSONAS:
      return getPersonaPages();
    case SITEMAP_IDS.GLOSSARY:
      return getGlossaryPages();
    default:
      return [];
  }
}
