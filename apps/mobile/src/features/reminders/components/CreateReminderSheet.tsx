    ...
    >
      ...
      <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
        <Pressable onPress={() => cycleHour(-1)} hitSlop={12}>
          <Text
            style={{ color: "#16c1ff", fontSize: fontSize.md + 4, fontWeight: "300" }}
          >
            ‹
          </Text>
        </Pressable>
        ...
        >
          ...
          >
            ...
            <View style={{ gap: spacing.xs }}>
              <Text
                style={{ fontSize: fontSize.sm, color: "#71717a" }}
              >
                Title *
              </Text>
              <TextInput
            ...
            <View style={{ gap: spacing.sm }}>
              ...
              {schedule.preset === "custom" && (
                <View style={{ gap: spacing.xs }}>
                  ...
                  />
                  <Text
                    style={{ fontSize: fontSize.xs, color: "#3f3f46" }}
                  >
              ...
              >
                <Text
                  style={{ fontSize: fontSize.sm, color: "#16c1ff" }}
                >
