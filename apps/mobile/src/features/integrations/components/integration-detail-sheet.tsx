...
function StatusPill({ status }: StatusPillProps) {
  ...
  return (
    ...
    >
      ...
      />
      <Text style={{ fontSize: fontSize.sm, color: cfg.color, fontWeight: "600" }}>
        {cfg.label}
      </Text>
    </View>
  );
...
>(({ onConnect, onDisconnect, onDelete, onEdit, onRefresh }, ref) => {
  ...
  const visibleTools =
    toolsExpanded ? tools : tools.slice(0, TOOLS_INITIAL_COUNT);
    ...
    >
      ...
      >
        ...
        {showTokenInput && !isConnected && (
          ...
          >
            <Text
              style={{ fontSize: fontSize.sm, color: "#a1a1aa", fontWeight: "500" }}
            >
              API Token
            </Text>
            <TextInput
        ...
        {isConnected && authType === "bearer" && !showTokenInput && (
          ...
          >
            ...
            <Text style={{ fontSize: fontSize.sm, color: "#00bbff", fontWeight: "500" }}>
              Update API Token
            </Text>
          </Pressable>
        )}
          ...
          >
            ...
            <View style={{ flexDirection: "row", gap: spacing.sm }}>
              ...
              >
                ...
                <Text
                  style={{ fontSize: fontSize.sm, color: "#ef4444", fontWeight: "500" }}
                >
                  Delete
                </Text>
              </Pressable>
