    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <Text
              style={{ color: "#000", fontWeight: "600", fontSize: fontSize.sm }}
            >
              Back to Settings
            </Text>
          </Pressable>
    ...
    >
      ...
      >
        ...
        >
          ...
          <AppIcon icon={DocumentAttachmentIcon} size={16} color={C.textMuted} />
        </Pressable>
        ...
        >
          {isSubmitting ? (
            ...
            <Text
              style={{ color: "#000", fontWeight: "600", fontSize: fontSize.base }}
            >
              Submit Ticket
            </Text>
          )}
