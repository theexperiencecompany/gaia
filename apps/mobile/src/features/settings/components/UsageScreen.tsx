...
import { AppIcon, ArrowLeft01Icon, ChartLineData02Icon } from "@/components/icons";
    ...
    <View>
      ...
      >
        {entries.map(([key, tok], index) => {
          const p = tok.periods[period];
          if (!p) return null;
          const pct = p.limit > 0 ? Math.min((p.total_tokens / p.limit) * 100, 100) : 0;
          return (
            <View key={key}>
              {index > 0 && (
                <View
              ...
              <View style={{ padding: spacing.md, gap: spacing.sm }}>
                ...
                >
                  <View style={{ flex: 1 }}>
                    ...
                    <Text
                      style={{ fontSize: fontSize.xs, color: C.textMuted, marginTop: 2 }}
                    >
            ...
            return (
              ...
              >
                {total > 0 ? (
                  ...
                  <Text style={{ fontSize: fontSize.xs - 2, color: "transparent" }}>
                    0
                  </Text>
                )}
                <View
                  style={{
                    ...
                    borderRadius: 4,
                    backgroundColor: total > 0 ? C.primary : "rgba(255,255,255,0.06)",
                  }}
                />
                <Text
                  style={{
