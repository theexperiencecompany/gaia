...
function SelectPicker({
  ...
  return (
    <View>
      ...
      >
        <Text style={{ fontSize: fontSize.sm, color: selectedLabel ? "#fff" : "#52525b" }}>
      ...
      {fields.map(({ name, schema, derivedOptions }) => {
        ...
        return (
          <View key={name} style={{ gap: spacing.xs }}>
            ...
            {schema.type === "boolean" ? (
            ...
            ) : schema.type === "string" && derivedOptions && derivedOptions.length > 0 ? (
              <SelectPicker
              ...
              <TextInput
                ...
                placeholder={
                  schema.description ?? String(schema.default ?? "")
                }
                placeholderTextColor="#52525b"
                value={currentValue != null ? String(currentValue) : ""}
