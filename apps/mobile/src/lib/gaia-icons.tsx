 ...
 *
 * React Native wrappers for @theexperiencecompany/gaia-icons using
 * react-native-svg and pre-extracted SVG path data.
 *
...
function createIcon(name: IconName) {
  ...
  return function GaiaIcon({ size = 24, color = "#ffffff" }: IconProps) {
    return (
