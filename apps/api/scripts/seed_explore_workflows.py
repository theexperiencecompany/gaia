    ...
    workflows.append(
        {
            ...
            "steps": [
                create_step(
                    ...
                    {
                        "query": "category:promotions OR unsubscribe newer_than:1d",
                        "max_results": 20,
                    },
                ),
                create_step(
    ...
    workflows.append(
        {
            ...
            "steps": [
                create_step(
                    ...
                    {
                        "query": "from:(*vc.com OR *capital.com) newer_than:7d",
                        "max_results": 20,
                    },
                ),
                create_step(
    ...
    workflows.append(
        {
            ...
            "steps": [
                create_step(
                    ...
                    {
                        "query": "from:*customer* OR subject:feedback newer_than:1d",
                        "max_results": 25,
                    },
                ),
                create_step(
    ...
    workflows.append(
        {
            ...
            "steps": [
                create_step(
                    ...
                    {
                        "query": "trending topics content marketing SEO",
                        "num_results": 15,
                    },
                ),
                create_step(
    ...
    workflows.append(
        {
            ...
            "steps": [
                ...
                create_step(
                    ...
                    {
                        "query": "industry events content opportunities",
                        "num_results": 10,
                    },
                ),
                create_step(
    ...
    workflows.append(
        {
            ...
            "steps": [
                create_step(
                    ...
                    {
                        "query": "industry influencers content creators",
                        "num_results": 20,
                    },
                ),
                create_step(
