...
CLAUSES: tuple[Clause, ...] = (
    ...
    Clause(
        ...
        source="comms",
        starts_at="- DELEGATE EVERY REAL ASK:",
        ends_before="- YOU ARE THE USER'S ONLY WINDOW:",
    ...
    Clause(
        name="only_window",
        source="comms",
        starts_at="- YOU ARE THE USER'S ONLY WINDOW:",
        ends_before="- RELAY EVERY RESULT IN FULL:",
    ...
    Clause(
        ...
        source="comms",
        starts_at="- RELAY EVERY RESULT IN FULL:",
        ends_before="- NEVER FABRICATE:",
    ...
    Clause(
        ...
        source="comms",
        starts_at="- NEVER FABRICATE:",
        ends_before="- CONFIRM RISKY WRITES FIRST:",
    ...
    Clause(
        ...
        source="comms",
        starts_at="- CONFIRM RISKY WRITES FIRST:",
        ends_before="- HONOR STATED CHANNELS:",
    ...
    Clause(
        ...
        source="comms",
        starts_at="- HONOR STATED CHANNELS:",
        ends_before="- ONE ENTITY:",
    ...
    Clause(
        name="one_entity",
        source="comms",
        starts_at="- ONE ENTITY:",
        ends_before="- GROUND TRUTH:",
    ...
    Clause(
        name="ground_truth",
        source="comms",
        starts_at="- GROUND TRUTH:",
        ends_before="- NO INVENTED CAPABILITIES:",
    ...
    Clause(
        ...
        source="comms",
        starts_at="- NO INVENTED CAPABILITIES:",
        ends_before="—Response Style (Human WhatsApp Mode)—",
    ...
    Clause(
        ...
        source="comms",
        starts_at="- Banned phrases, never say these",
    ...
    Clause(
        ...
        source="comms",
        starts_at="— Content vs Conversation Length — (CRITICAL)",
        ends_before="— Multiple Chat Bubbles: (VERY IMPORTANT styling)",
    ...
    Clause(
        ...
        source="comms",
        starts_at="**WRITE LIKE A HUMAN (applies to ALL content you produce):**",
        ends_before="**How to tell which mode:**",
    ...
    Clause(
        ...
        source="comms",
        starts_at="— Multiple Chat Bubbles: (VERY IMPORTANT styling)",
    ...
    Clause(
        ...
        source="comms",
        starts_at="**TONE IS NOT INTENT (READ FIRST):**",
        ends_before="**NEVER FABRICATE ACTIONS OR RESULTS (ABSOLUTE RULE):**",
    ...
    Clause(
        ...
        source="comms",
        starts_at="**ACKNOWLEDGE EXACTLY ONCE (READ CAREFULLY):**",
        ends_before="1. Call the tool silently,",
    ...
    Clause(
        ...
        source="comms",
        starts_at="- The acceptance/queued message includes a task_id:",
    ...
    Clause(
        ...
        source="comms",
        starts_at="- NEVER reproduce the literal markers in your reply.",
    ...
    Clause(
        ...
        source="comms",
        starts_at="- LONG-FORM DELIVERABLES (CRITICAL, READ CAREFULLY):",
        ends_before="   - SMALL RESULTS",
    ...
    Clause(
        ...
        source="comms",
        starts_at="—Executor Ground Truth Contract (CRITICAL)—",
        ends_before="—Rate Limiting & Subscription—",
