...
class TestRedisCacheWithRealRedis:
    ...
    Uses the real_redis fixture from tests/service/conftest.py which patches
    redis_cache.redis to a real Redis connection. These tests catch issues that
    mocks cannot: real TTL enforcement, actual key expiry, encoding edge cases.
    """
