...
def test_the_hard_tier_is_deep_in_every_category_it_claims() -> None:
    """A hard category with one case does not measure difficulty — it measures whether that one prompt happened to land."""
...
def test_the_floor_can_actually_be_breached() -> None:
    """Mutation guard: a zero-case category must be rejected, or this file would pass forever regardless of the data."""
