...
async def record_llm_call(
    *,
    ...
    ``charge_to_budget`` is required so every call site states whether this
    spend counts against the user's allowance (agent-graph work the user asked
    for) or is auxiliary background COGS (recorded durably, never charged).
