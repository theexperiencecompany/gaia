...
def _email_intelligence() -> CreateWorkflowRequest:
    return CreateWorkflowRequest(
        ...
        prompt=(
            ...
            "URGENT-SIGNAL GATE: if — and only if — something is genuinely time-critical, meaning "
            "waiting for the next morning briefing would cause a missed meeting, a blown deadline, "
            "or a lost opportunity (a meeting moved to today, a payment failing now, a same-day "
            "deadline at risk), send ONE immediate alert for it with the send_urgent_alert tool. "
            "The bar is strict: merely interesting, could-be-useful, or FYI items NEVER qualify — "
            "they belong in the briefing. Two genuine emergencies mean two alerts; zero means zero. "
