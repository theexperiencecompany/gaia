...
async def search_public_integrations(
    ...
    try:
        ...
        # Re-raise so an unreachable ChromaDB isn't reported as "no matching integrations" —
        # the marketplace endpoint should 500 honestly rather than render an empty catalog.
        log.error(
