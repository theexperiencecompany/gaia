...
_original_execute_action = Registry.execute_action


async def _execute_action(
    self: Registry[Any], action_name: str, params: dict[str, Any], *args: Any, **kwargs: Any
) -> Any:  # noqa: ANN401 -- Browser-Use's own return type
    ...
    return await _original_execute_action(self, action_name, params, *args, **kwargs)
