...
OAUTH_INTEGRATIONS: List[OAuthIntegration] = [
    ...
    OAuthIntegration(
        ...
        subagent_config=SubAgentConfig(
            ...
            specific_tools=[
                # Core message retrieval/search
                "GMAIL_FETCH_EMAILS",
                "GMAIL_FETCH_MESSAGE_BY_MESSAGE_ID",
                "GMAIL_FETCH_MESSAGE_BY_THREAD_ID",
                "GMAIL_LIST_MESSAGES",
                "GMAIL_LIST_THREADS",
                # Message organization and labeling
                "GMAIL_LIST_LABELS",
                "GMAIL_GET_LABEL",
                "GMAIL_CREATE_LABEL",
                "GMAIL_UPDATE_LABEL",
                ...
                # Message state and lifecycle actions
                "GMAIL_MOVE_TO_TRASH",
                ...
                # Filters and settings safe for mailbox automation
                "GMAIL_CREATE_FILTER",
                "GMAIL_LIST_FILTERS",
                "GMAIL_GET_FILTER",
                "GMAIL_DELETE_FILTER",
                ...
                # Contacts/profile/attachments
                "GMAIL_GET_PROFILE",
                "GMAIL_GET_CONTACTS",
                "GMAIL_GET_PEOPLE",
                "GMAIL_SEARCH_PEOPLE",
                "GMAIL_GET_ATTACHMENT",
                # Custom Gmail tools (must stay explicitly allow-listed)
