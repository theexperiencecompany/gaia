...
async def gather_context(
    ...
    resolved_providers = await resolve_providers(providers, user_id, PROVIDER_TOOLS, tool_namespace)

    # Use None (default thread pool) for the outer call; fetch_all_providers
    # internally uses _CONTEXT_EXECUTOR. Passing _CONTEXT_EXECUTOR here would
    # cause a pool-within-pool deadlock at max_workers=4 concurrent sessions.
