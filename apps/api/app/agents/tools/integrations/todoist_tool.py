...
def register_todoist_custom_tools(composio: Composio[Any, Any]) -> list[str]:  # type: ignore[explicit-any]
    ...
    def CUSTOM_GATHER_CONTEXT(
        ...
        tasks = data.get("items", data.get("tasks", data)) if isinstance(data, dict) else data
