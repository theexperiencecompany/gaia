...
- At least ONE workflow must use an integration trigger (fires when something happens, e.g. a new email matching a pattern, a calendar event starting, a GitHub PR opened, a Slack message) rather than a fixed schedule.
