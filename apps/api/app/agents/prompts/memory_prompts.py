...
# =============================================================================
# GAIA SELF-KNOWLEDGE MEMORY PROMPT
# =============================================================================

GAIA_MEMORY_PROMPT = BASE_MEMORY_EXTRACTION_PROMPT.format(
    provider_name="GAIA Self-Knowledge",
    entity_instructions="""
## GAIA SELF-KNOWLEDGE EXTRACTION:

1. CAPABILITY INTERESTS:
   - Features the user asked about most
   - Integrations the user is interested in connecting

2. ONBOARDING PROGRESS:
   - Which integrations the user has set up
   - Features the user has discovered and uses regularly

3. FEATURE GAPS:
   - Capabilities the user wished GAIA had (useful for product feedback)
   - Features the user was surprised to learn about
""",
    provider_specific_instructions="""
## GAIA-SPECIFIC MEMORIES:

INTEGRATION INTERESTS:
- Which integrations prompted the user's question
- "User asked about Linear integration support"

ONBOARDING PATTERNS:
- Features the user plans to set up next
- "User wants to connect Gmail and Calendar"

USAGE PREFERENCES:
- How the user prefers to interact with GAIA
- Communication style preferences
- Preferred response format for capability explanations
""",
)
