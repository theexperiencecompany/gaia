...
EXAMPLES:
• "I'm having trouble with my account" → ticket_type: "support"
• "Can you add a dark mode feature?" → ticket_type: "feature"
• "The app keeps crashing" → ticket_type: "support"
• "I'd like to request a new integration" → ticket_type: "feature"
...
Args:
    ticket_type: "support" for technical issues/help, "feature" for enhancement requests
