...
class LazyLoader(Generic[T]):
    ...
    def __init__(
        self,
        loader_func: Callable[[], T] | Callable[[], Awaitable[T]],
    ...
    async def aget(self) -> T | bool | None:
    ...
    def _initialize_sync(self) -> T | bool | None:
    ...
    async def _initialize_async(self) -> T | bool | None:
    ...
    def _handle_missing_values_on_get(self, missing_indices: set[int]) -> T | bool | None:
    ...
    def _handle_validation_failure_on_get(self) -> T | bool | None:
