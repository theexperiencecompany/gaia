...
class LinkPlatformRequest(BaseModel):  # type: ignore[explicit-any]
...
class InitiatePlatformConnectRequest(BaseModel):  # type: ignore[explicit-any]
...
class GetPlatformLinksResponse(BaseModel):  # type: ignore[explicit-any]
...
class PlatformLinkResult(BaseModel):  # type: ignore[explicit-any]
...
class LinkPlatformResponse(BaseModel):  # type: ignore[explicit-any]
...
class PendingPlatformRegistrationDocument(MongoDocument):  # type: ignore[explicit-any]
...
class PendingPlatformRegistrationUpdate(BaseModel):  # type: ignore[explicit-any]
...
class DisconnectPlatformResponse(BaseModel):  # type: ignore[explicit-any]
...
class InitiatePlatformConnectResponse(BaseModel):  # type: ignore[explicit-any]
