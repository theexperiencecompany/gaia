...
mise dev          # Start development (backend + web + docker)
...
| Command       | Description          |
| ------------- | -------------------- |
| `mise lint`   | Lint backend + web   |
| `mise format` | Format backend + web |
...
```bash
mise -C apps/backend dev      # Backend from root
