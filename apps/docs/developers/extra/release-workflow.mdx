...
<Note>
This allows you to correct commit messages that will appear in the release notes after the fact.
</Note>

## Resources

<CardGroup cols={2}>
  <Card title="Release Please Docs" icon="book" href="https://github.com/googleapis/release-please">
    Official Release Please documentation
  </Card>
  <Card title="Conventional Commits" icon="git-alt" href="https://www.conventionalcommits.org/">
    Learn about conventional commit specification
  </Card>
  <Card title="Customizing Guide" icon="wrench" href="https://github.com/googleapis/release-please/blob/main/docs/customizing.md">
    Advanced customization options
  </Card>
  <Card title="Troubleshooting Guide" icon="bug" href="https://github.com/googleapis/release-please/blob/main/docs/troubleshooting.md">
