...
Runs all services including web, backend, databases, workers, and development tools:
...
Runs backend services, databases, workers, and development tools - excludes the web:
...
<Note>
  ...
  the web manually with `mise dev` for faster hot reloading.
</Note>
