    ...
    workflows.append({
        ...
        "steps": [
            create_step(
                ...
                {"query": "category:promotions OR unsubscribe newer_than:1d", "max_results": 20},
            ),
            create_step(
                2,
    ...
    workflows.append({
        ...
        "steps": [
            create_step(
                ...
                {"query": "startup industry trends", "num_results": 10},
            ),
            create_step(
                2,
                "Draft LinkedIn Post",
    ...
    workflows.append({
        ...
        "steps": [
            create_step(
                ...
                {"query": "from:(*vc.com OR *capital.com) newer_than:7d", "max_results": 20},
            ),
            create_step(
                2,
                "Update Airtable CRM",
    ...
    workflows.append({
        ...
        "steps": [
            create_step(
                ...
                {"query": "from:*customer* OR subject:feedback newer_than:1d", "max_results": 25},
            ),
            create_step(
                2,
                ...
                {"query": "your product name feedback reviews", "num_results": 15},
            ),
            create_step(
                3,
    ...
    workflows.append({
        ...
        "steps": [
            create_step(
                ...
                {"query": "trending topics content marketing SEO", "num_results": 15},
            ),
            create_step(
                2,
    ...
    workflows.append({
        ...
        "steps": [
            ...
            create_step(
                ...
                {"query": "industry events content opportunities", "num_results": 10},
            ),
            create_step(
                3,
    ...
    workflows.append({
        ...
        "steps": [
            create_step(
                ...
                {"query": "competitor name announcements news", "num_results": 20},
            ),
            create_step(
                2,
    ...
    workflows.append({
        ...
        "steps": [
            create_step(
                ...
                {"query": "your brand name social mentions", "num_results": 15},
            ),
            create_step(
                2,
                "Log to Airtable",
    ...
    workflows.append({
        ...
        "steps": [
            create_step(
                ...
                {"query": "industry influencers content creators", "num_results": 20},
            ),
            create_step(
                2,
    ...
    workflows.append({
        ...
        "steps": [
            ...
            create_step(
                ...
                {"query": "newer_than:7d", "max_results": 20},
            ),
            create_step(
                3,
    ...
    workflows.append({
        ...
        "steps": [
            create_step(
                ...
                {"query": "document topic research", "num_results": 12},
            ),
            create_step(
                2,
                "Generate Outline",
