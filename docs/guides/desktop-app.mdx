...
<Note>
  ...
  [app.heygaia.io](https://app.heygaia.io) is available in the desktop version.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Use keyboard shortcuts" icon="keyboard">
    ...
    <code>/</code> in chat to open the command palette, or use standard OS
    shortcuts like <code>Cmd+T</code> / <code>Ctrl+T</code> for new tabs where
    supported.
  </Card>
