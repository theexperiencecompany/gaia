...
<BotChatDemo
  ...
  messages={[
    ...
    {
      from: "gaia",
      text: "You have 6 open todos. Two are overdue: the Q2 investor update (due yesterday) and the design handoff (due Monday). Want me to reschedule them or bump their priority?",
    },
    { from: "user", text: "Bump the investor update to p1 and push the handoff to Friday" },
    {
      from: "gaia",
      text: "Done — investor update is now priority 1, design handoff moved to Friday.",
    },
  ]}
/>
