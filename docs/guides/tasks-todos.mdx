...
<Chat
  messages={[
    ...
    { from: "user", text: "create a todo to update the landing page copy, label it marketing" },
    { from: "user", text: "I need to prepare slides for Monday's presentation, add that to my Work project" },
    { from: "user", text: "what are my high priority tasks this week?" },
    { from: "user", text: "show me all overdue tasks" },
