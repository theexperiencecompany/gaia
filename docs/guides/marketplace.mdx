...
**Integrations** — browse the [GAIA Marketplace](https://heygaia.io/marketplace). Search uses semantic matching, so describe what you need in plain language instead of guessing the exact name:

> a tool that manages my notion databases
