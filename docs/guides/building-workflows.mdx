...
<Chat
  messages={[
    ...
    { from: "user", text: "Check my unread emails, extract any action items, and create a todo for each one." },
    { from: "user", text: "Look at all merged PRs and commits from the past week across our repos. Summarize them into standup notes grouped by project." },
  ]}
/>
