...
<Chat
  messages={[
    { from: "user", text: "remind me to call the dentist in 30 minutes" },
    { from: "gaia", text: "Set, I'll remind you to call the dentist in 30 minutes." },
    { from: "user", text: "remind me to submit the quarterly report tomorrow at 9 AM" },
    { from: "user", text: "every Monday at 9 AM, remind me to review my weekly goals" },
...
<Chat
  messages={[
    { from: "user", text: "show me my upcoming reminders" },
    { from: "user", text: "change my daily medication reminder to 9 PM instead of 8 PM" },
    { from: "user", text: "pause my weekday wrap-up reminder" },
    { from: "gaia", text: "Paused, it'll stay put without firing until you resume it." },
    { from: "user", text: "resume my weekday wrap-up reminder" },
    { from: "user", text: "cancel my Monday goals reminder" },
  ]}
/>
