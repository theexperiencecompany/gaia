...
<Frame>
  <img className="rounded-lg" src="/images/guides/chat/chat-page.png" alt="GAIA chat interface" />
</Frame>
...
<Tip>
  Not sure what details to include? Start with **who**, **what**, and **when**.
  "Send Alex a Slack message about the Friday standup" covers all three.
</Tip>
...
<Note>
  Follow-up suggestions change with every response because they're based on the
...
<Frame>
  <img className="rounded-lg" src="/images/guides/chat/chat-conversation.png" alt="GAIA chat conversation showing a response with follow-up action suggestions" />
</Frame>

<Tip>
  Starting a new conversation keeps things clean. GAIA carries over your
  memories, but a fresh thread helps it focus on your current task without noise
