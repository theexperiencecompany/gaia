...
<Chat
  messages={[
    { from: "user", text: "show me my latest 5 emails" },
    { from: "gaia", text: "Here are your latest 5, two are unread." },
    { from: "user", text: "do I have any unread emails from this week?" },
    { from: "user", text: "find emails from sarah@acme.com about the Q3 proposal" },
    { from: "user", text: "show me the full thread with David about the partnership deal" },
...
<Chat
  messages={[
    { from: "user", text: "create a label called 'Client Projects'" },
    { from: "user", text: "add the 'Urgent' label to the last 3 emails from my manager" },
