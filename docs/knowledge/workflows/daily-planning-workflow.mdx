...
Once your integrations are connected, open the workflow builder and search for "Daily Planning" in the community templates. GAIA offers a pre-built workflow that you can customize to your preferences. The default template triggers at 7 AM in your local time zone, but you can adjust this to match your routine—if you're an early riser who starts work at 6 AM, set it for 5:45 AM so your briefing is ready when you sit down. If you prefer to ease into your morning, 8 AM might work better.
