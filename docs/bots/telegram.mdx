---
title: "Telegram"
description: "Use the GAIA Telegram bot to chat with your AI assistant, manage todos, and run workflows in private messages."
icon: "telegram"
---
...
<Card
  title="Message GAIA on Telegram"
  icon="telegram"
...
<Tip>
  Telegram DMs are fully private — only you and GAIA see the conversation. You
  can send free-text messages at any time without using a command prefix.
</Tip>
