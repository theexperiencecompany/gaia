---
title: "Discord"
description: "Set up and use the GAIA Discord bot to chat with your AI assistant, manage tasks, and run workflows in your server."
icon: "discord"
---
...
<Tip>
  DMs are the most private way to use GAIA on Discord. Your messages are only
  visible to you and the bot — no server members can see the conversation.
</Tip>
