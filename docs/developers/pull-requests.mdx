...
3. Reviewed [existing issues](https://github.com/heygaia/gaia/issues) and PRs
...
<Steps>
  ...
  <Step title="Create Pull Request">
    Go to [github.com/heygaia/gaia](https://github.com/heygaia/gaia) and create a pull request.
  </Step>
</Steps>
...
- **Discussions**: [GitHub Discussions](https://github.com/heygaia/gaia/discussions)
