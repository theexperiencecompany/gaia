...
GAIA has two layers of commands:

- **[GAIA CLI](/cli/commands)** (`gaia`) - Install, configure, and manage GAIA instances
- **mise + Nx** - Development tooling for building, testing, and running individual services

### GAIA CLI Commands

For managing your GAIA instance. See [CLI Commands](/cli/commands) for full details.
...
For development workflows. Run `mise tasks` to see all available commands.
