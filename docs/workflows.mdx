...
<Chat
  messages={[
    ...
    { from: "user", text: "Every Friday at 4pm, summarize my completed Asana tasks into a Google Doc" },
    { from: "user", text: "30 minutes before any meeting with more than 2 attendees, surface my recent email threads with those people" },
    { from: "gaia", text: "Done, these workflows are set up and will run on their own from now on." },
  ]}
/>
