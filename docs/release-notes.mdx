...
- **Security Fixes**: Audited SSRF, IDOR, auth, and webhook findings across the codebase were remediated, along with 192 dependency advisories.
...
- **Private Browsing**: When the browser blocks local storage, the app degrades gracefully instead of failing to load.
...
### Infrastructure
- **Next.js 16.3 and TypeScript 7**: The web app moved onto the new native TypeScript compiler, which made builds and type-checking noticeably faster.
