...
<Update label="Jun 30, 2026" description="API, Web, Desktop, Bots">
...
## [Desktop v0.4.1](https://github.com/theexperiencecompany/gaia/releases/tag/desktop-v0.4.1)

### Bug Fixes
- **Logout Routing**: Logging out now returns you to the desktop login screen instead of the landing page.

## [Bots v1.4.2](https://github.com/theexperiencecompany/gaia/releases/tag/bots-v1.4.2)
